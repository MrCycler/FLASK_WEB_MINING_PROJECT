                        ...
                        <div className="col">
                            <div className="text-center">
                                ...
                                <div className="section_subtitle">
                                    <h4>TPM Analytics (Tendencias de Publicación de Medios) muestra las actuales tasas de publicación de tres medios principales de noticias en el Perú, basado en cuatro categprías: Policiales/Crimen, Política/Economía, Sociales/Entretenimiento y Deportes.</h4>
                                    <br></br>
                                    <h4>Con estas tasas podemos analizar y/o inferir: Qué categoría es la tendencia principal de publicación de cada medio, cuál es la tendencia de publicación a nivel general; cuáles son los campos de mayor interés hacia el público y 
                                    otras más. Dejamos a su elección buscar otros tipos de análisis. </h4>
                                </div>
                            </div>
